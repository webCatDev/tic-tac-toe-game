export default {
  English: {
    gameSettings: {
      ...
      playerTagLabel: ["Player Tag", "Tag of Player 1"],
      musicLabel: "Music",
      ...
      difficultyTexts: ["Easy", "Normal", "Hard"],
  ...
  Türkçe: {
    gameSettings: {
      ...
      playerNamePlaceholder: "İsminizi girin",
      player2Label: "Oyuncu 2",
      playerTagLabel: ["Oyuncu Etiketi", "Birinci Oyuncunun Etiketi"],
      musicLabel: "Müzik",
      ...
      difficultyTexts: ["Kolay", "Orta", "Zor"],
